...
Ext.onReady(function () {
    ...
    function refresh() {
        ...
        for (i = 0; i < len; i++) {
            ...
            s.xField = rc.xField;
            s.yField = rc.yField;
            color = rc.color ? Renderers.color(rc.color, rc.colorFrom, rc.colorTo, 0, 100) : function (a, b, attr) {
                return attr;
            };
            grayscale = rc.grayscale ? Renderers.grayscale(rc.grayscale, rc.scaleFrom, rc.scaleTo, 0, 100) : function (a, b, attr) {
                return attr;
            };
            radius = rc.radius ? Renderers.radius(rc.radius, 10, rc.radiusSize, 0, 100) : function (a, b, attr) {
                return attr;
            };
    ...
    var colorMenu = Ext.create('Ext.menu.Menu', {
        items: [
            { text: 'data1', handler: colorVariableHandler, checked: false, group: 'color' },
            ...
            { text: 'Color From',
                menu: {
                    items: [
                        { text: 'rgb(250, 20, 20)', handler: colorToHandler, checked: true, group: 'colorrange' },
            ...
            { text: 'Color To',
                menu: {
                    items: [
                        { text: 'rgb(250, 20, 20)', handler: colorToHandler, checked: false, group: 'tocolorrange' },
    ...
    var grayscaleMenu = Ext.create('Ext.menu.Menu', {
        items: [
            { text: 'data1', handler: grayscaleVariableHandler, checked: false, group: 'gs' },
            ...
            { text: 'Scale From',
                menu: {
                    items: [
                        { text: 'rgb(20, 20, 20)', handler: scaleFromHandler, checked: true, group: 'gsrange' },
            ...
            { text: 'Scale To',
                menu: {
                    items: [
                        { text: 'rgb(20, 20, 20)', handler: scaleToHandler, checked: false, group: 'togsrange' },
    ...
    var radiusMenu = Ext.create('Ext.menu.Menu', {
        ...
        items: [
            { text: 'data1', handler: radiusHandler, checked: false, group: 'radius' },
            { text: 'data2', handler: radiusHandler, checked: false, group: 'radius' },
            { text: 'data3', handler: radiusHandler, checked: false, group: 'radius' },
            { text: 'Max Radius',
                menu: {
                    items: [
                        { text: '20', handler: radiusSizeHandler, checked: false, group: 'sradius' },
