...
(function () {
    ...
    Ext.apply(Ext, {name: Ext.sandboxName || "Ext", emptyFn: f, identityFn: function (i) {
        return i
    ...
    }, Logger: {verbose: f, log: f, info: f, warn: f, error: function (i) {
        throw new Error(i)
    }, deprecate: f}});
    Ext.type = Ext.typeOf;
    g = Ext.app;
...
Ext.String = (function () {
    var i = /^[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000]+|[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000]+$/g, m = /('|\\)/g, h = /\{(\d+)\}/g, b = /([-.*+?\^${}()|\[\]\/\\])/g, n = /^\s+|\s+$/g, j = /\s+/, l = /(^[^a-z]*|[^\w])/gi, e, a, g, d, f = function (p, o) {
        return e[o]
    }, k = function (p, o) {
...
Ext.Number = new function () {
    ...
    Ext.apply(this, {constrain: function (g, f, e) {
        var d = parseFloat(g);
...
(function () {
    ...
    s = p ? h : w;
    u = p ? g : k;
    a = Ext.Array = {each: function (C, A, z, e) {
        C = a.from(C);
        var y, B = C.length;
        if (e !== true) {
            for (y = 0; y < B; y++) {
...
Ext.Date = new function () {
    ...
    Ext.apply(d, {now: Date.now || function () {
    ...
    }, useStrict: false, formatCodeToRegex: function (k, j) {
        var l = d.parseCodes[k];
        if (l) {
            l = typeof l == "function" ? l() : l;
            d.parseCodes[k] = l
        }
        return l ? Ext.applyIf({c: l.c ? g(l.c, j || "{0}") : l.c}, l) : {g: 0, c: null, s: Ext.String.escapeRegex(k)}
    }, parseFunctions: {MS: function (k, j) {
        var l = (k || "").match(f);
        ...
        return m.join(" + ")
    }, U: "Math.round(this.getTime() / 1000)"}, isValid: function (r, j, q, o, l, n, k) {
        o = o || 0;
        l = l || 0;
        n = n || 0;
        k = k || 0;
        ...
        var m = [], j = [d.formatCodeToRegex("Y", 1), d.formatCodeToRegex("m", 2), d.formatCodeToRegex("d", 3), d.formatCodeToRegex("H", 4), d.formatCodeToRegex("i", 5), d.formatCodeToRegex("s", 6), {c: "ms = results[7] || '0'; ms = parseInt(ms, 10)/Math.pow(10, ms.length - 3);\n"}, {c: ["if(results[8]) {", "if(results[8] == 'Z'){", "zz = 0;", "}else if (results[8].indexOf(':') > -1){", d.formatCodeToRegex("P", 8).c, "}else{", d.formatCodeToRegex("O", 8).c, "}", "}"].join("\n")}], n, k;
        for (n = 0, k = j.length; n < k; ++n) {
            m.push(j[n].c)
        }
        return{g: 1, c: m.join(""), s: [j[0].s, "(?:", "-", j[1].s, "(?:", "-", j[2].s, "(?:", "(?:T| )?", j[3].s, ":", j[4].s, "(?::", j[5].s, ")?", "(?:(?:\\.|,)(\\d+))?", "(Z|(?:[-+]\\d{2}(?::)?\\d{2}))?", ")?", ")?", ")?"].join("")}
    }, U: {g: 1, c: "u = parseInt(results[{0}], 10);\n", s: "(-?\\d+)"}}, dateFormat: function (j, k) {
        return d.format(j, k)
        ...
        return function (m) {
            var n = Date.UTC(m.getFullYear(), m.getMonth(), m.getDate() + 3) / j, l = Math.floor(n / 7), o = new Date(l * k).getUTCFullYear();
...
(function (a) {
    ...
    Ext.apply(b, {$className: "Ext.Base", $isClass: true, create: function () {
        ...
        var n = this.prototype, m = Ext.Class.configNameCache, i = n.configMap, j = n.initConfigList, g = n.initConfigMap, k = n.config, e, f, o;
        for (f in h) {
    ...
    b.implement({isInstance: true, $className: "Ext.Base", configClass: Ext.emptyFn, initConfigList: [], configMap: {}, initConfigMap: {}, statics: function () {
        ...
        var m = g, l = Ext.Class.configNameCache, j = new this.configClass(), p = this.initConfigList, h = this.configMap, o, k, n, f, e;
...
(function () {
    ...
    Ext.apply(c, {onBeforeCreated: function (h, i, g) {
        h.addMembers(i);
        ...
        var h = o.preprocessors || c.defaultPreprocessors, r = this.preprocessors, u = {onBeforeCreated: this.onBeforeCreated}, t = [], v, n, m, s, l, q, p;
        ...
        if (!j) {
            ...
            j = h[i] = {internal: i, initialized: "_is" + g + "Initialized", apply: "apply" + g, update: "update" + g, set: "set" + g, get: "get" + g, doSet: "doSet" + g, changeEvent: i.toLowerCase() + "change"}
        }
        return j
    }});
    ...
    c.registerPreprocessor("config", function (g, j) {
        ...
        Ext.Object.each(i, function (m, v) {
            var t = c.getConfigNameMap(m), p = t.internal, k = t.initialized, u = t.apply, n = t.update, s = t.set, l = t.get, x = (s in h) || j.hasOwnProperty(s), o = (u in h) || j.hasOwnProperty(u), q = (n in h) || j.hasOwnProperty(n), w, r;
            if (v === null || (!x && !o && !q)) {
                h[p] = v;
                h[k] = true
            } else {
...
(function (c, e, g, d, f) {
    ...
    var b = Ext.ClassManager = {classes: {}, existCache: {}, namespaceRewrites: [
        {from: "Ext.", to: Ext}
    ], maps: {alternateToName: {}, aliasToName: {}, nameToAliases: {}, nameToAlternates: {}}, enableNamespaceParseCache: true, namespaceParseCache: {}, instantiators: [], isCreated: function (m) {
        ...
        return true
    }, createdListeners: [], nameCreatedListeners: {}, triggerCreated: function (r) {
        var t = this.createdListeners, l = this.nameCreatedListeners, m = this.maps.nameToAlternates[r], s = [r], o, q, n, p, k, h;
        ...
        return m
    }, postprocessors: {}, defaultPostprocessors: [], registerPostprocessor: function (i, l, j, h, k) {
        if (!h) {
            h = "last"
        }
        if (!j) {
    ...
    Ext.apply(Ext, {create: e(b, "instantiate"), widget: function (j, i) {
        var n = j, k, l, h, m;
        if (typeof n != "string") {
            i = j;
            n = i.xtype
        ...
        var k = b.classes, r = b.maps, s = r.aliasToName, t = r.nameToAliases, v = r.alternateToName, n = r.nameToAlternates, h = t[p], q = n[p], l, u, j, m;
    ...
    c.registerPreprocessor("alias", function (t, n) {
        var r = t.prototype, k = d(n.xtype), h = d(n.alias), u = "widget.", s = u.length, o = Array.prototype.slice.call(r.xtypesChain || []), l = Ext.merge({}, r.xtypesMap || {}), m, q, p, j;
...
Ext.Loader = new function () {
    var j = this, b = Ext.ClassManager, s = Ext.Class, e = Ext.Function.flexSetter, n = Ext.Function.alias, a = Ext.Function.pass, d = Ext.Function.defer, g = Ext.Array.erase, m = ["extend", "mixins", "requires"], u = {}, l = [], c = /\/\.\//g, f = /\./g, i = 0;
    Ext.apply(j, {isInHistory: u, history: l, config: {enabled: false, scriptChainDelay: false, disableCaching: true, disableCachingParam: "_dc", garbageCollect: false, paths: {Ext: "."}, preserveScripts: true, scriptCharset: undefined}, setConfig: function (x, y) {
    ...
    Ext.apply(j, {documentHead: typeof document != "undefined" && (document.head || document.getElementsByTagName("head")[0]), isLoading: false, queue: p, isClassFileLoaded: q, isFileLoaded: t, readyListeners: v, optionalRequires: w, requiresMap: h, numPendingFiles: 0, numLoadedFiles: 0, hasFileLoadError: false, classNameToFilePathMap: r, scriptsLoading: 0, syncModeEnabled: false, scriptElements: o, refreshQueue: function () {
        ...
        var A = j.getConfig(), z = typeof G == "string", y = z ? G : G.url, C = !z && G.onError, D = !z && G.onLoad, F = !z && G.scope, E = function () {
            j.numPendingFiles--;
            j.scriptsLoading--;
            if (C) {
        ...
        var A = j.getConfig(), J = y + (A.disableCaching ? ("?" + A.disableCachingParam + "=" + Ext.Date.now()) : ""), z = false, H, B, G, C = "";
        I = I || j;
        j.isLoading = true;
        if (!x) {
            G = function () {
